classdef SimMultiClampWithStage < symphonyui.core.descriptions.RigDescription
    
    methods
        
        function obj = SimMultiClampWithStage()
            ...
            obj.devices = {amp1, amp2, green, blue, trigger1, trigger2, stage};
        end
