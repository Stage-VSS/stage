classdef SimulatedHekaDaqWithMultiClamp700BAndStage < symphonyui.core.descriptions.RigDescription
    
    methods
        
        function obj = SimulatedHekaDaqWithMultiClamp700BAndStage()
